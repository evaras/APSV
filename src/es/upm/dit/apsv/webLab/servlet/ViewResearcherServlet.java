...
public class ViewResearcherServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Researcher rso = new Researcher(rsi ,null,null,null, null);
		Researcher rsa = dao.read(rso);
		request.getSession().setAttribute ("rselegido", rsa);
		System.out.println(rsa.getEmail());
		response.sendRedirect("/APSV/ViewResearchers.jsp");
